  ...
  <section id="about" className={styles.aboutSection}>
    <div className={styles.aboutContent}>
      ...
      <div className={styles.aboutText}>
        ...
        <p>
<<<<<<< HEAD
        This is <strong>Gowtham Medisetti</strong>, I am a <strong>Generative AI Engineer</strong> with a <strong>Master’s in Computer Science</strong> from UNT and over 5 years of experience. 
...
<<<<<<< HEAD
          ...
          <a href="https://shorturl.at/Y7eyX" target="_blank" rel="noopener noreferrer">
            <Image src="/images/oracle-badge.png" alt="Oracle Certification" width={60} height={60} />
          </a>
